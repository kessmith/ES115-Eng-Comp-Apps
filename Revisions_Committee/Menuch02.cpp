...
int main0204(); //individual example program function

int menuch02() // beginning of menu code
{
	...
	while (selection != 0) //begin while loop- condition while selection not equal to 0
	{
		...
		cout << "\n C++ Chapter 02 Examples \n \n"; //display text title

		int McCoyJames0301();//individual example program function
		printf("1. Chapter02 Example 01 \n"); //display text as option
		printf("2. Chapter02 Example 02 \n"); //display text as option
		printf("3. Chapter02 Example 03 \n"); //display text as option
		printf("4. Chapter02 Example 04 \n"); //display text as option
		...
		else if (selection == 4) //if user chooses third option
		{
			system("CLS"); //clear window
			mainDate(); //call name date function
			main0204(); //call indiviual example program function
		}
	}
	return 0; //return 0
}